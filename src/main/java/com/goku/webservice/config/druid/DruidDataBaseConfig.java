...
public class DruidDataBaseConfig {
    ...
    @Bean(name = "tran")     //声明其为Bean实例
    @Primary  //在同样的DataSource中，首先使用被标注的DataSource
    public DataSource trandataSource(){
    ...
    public DataSource dataSource() {
        ...
        // 默认数据源
        dynamicDataSource.setDefaultTargetDataSource(trandataSource());

        // 配置多数据源
        Map<Object, Object> dsMap = new HashMap(5);
        dsMap.put("tran", trandataSource());
